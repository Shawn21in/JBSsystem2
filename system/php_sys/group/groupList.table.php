                ...
                <?php } ?>
                    ...
                    <td>
                        ...
                        <?php if( $Operating['View'] ){ ?>
                            ...
                            <?php if( ( $Admin_data['Group_ID'] != $val_v && $Admin_data['Group_Lv'] >= $Value_Array['Group_Lv'][$key_v] ) || !Menu_Use($Now_List, 'view') ){ ?>
                        ...
                        <?php if( $Operating['Edit'] ){ ?>
                            ...
                            <?php if( ( $Admin_data['Group_ID'] != $val_v && $Admin_data['Group_Lv'] >= $Value_Array['Group_Lv'][$key_v] ) || !Menu_Use($Now_List, 'edit') ){ ?>
                            <a class="grey" href="javascript:void(0)">
