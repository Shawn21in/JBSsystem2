...
$config['licenseName'] = '';
$config['licenseKey']  = '1B1D-1111-A119-1A11-1911-T1M2-211J';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
	'baseUrl'      => substr($_SERVER['REQUEST_URI'], 0, stripos($_SERVER['REQUEST_URI'], "system")).'upload/userfiles/',
	//'baseUrl'      => 'https://judong.cdit.com.tw/upload/userfiles/',
	//'root'         => substr( __DIR__ , 0, stripos(__DIR__, "system")).'upload'.DIRECTORY_SEPARATOR.'userfiles',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
//$config['tempDirectory'] = "D:".DIRECTORY_SEPARATOR."webhost73".DIRECTORY_SEPARATOR."Temp";

$config['tempDirectory'] = sys_get_temp_dir();
/*
if (!is_writable($config['tempDirectory'])) {
     echo ' [ERROR] Cannot save to temp.';
} else {
     echo ' [OK] Temp saving enabled';
}
*/
