...
(function ($)
{
	$.fn.wipetouch = function (settings)
	{
		...
		var config = {
			...
			// Wipe events
			wipeLeft: true, // called on wipe left gesture
			wipeRight: true, // called on wipe right gesture
			wipeUp: true, // called on wipe up gesture
			wipeDown: true, // called on wipe down gesture
			wipeUpLeft: true, // called on wipe top and left gesture
			wipeDownLeft: true, // called on wipe bottom and left gesture
			wipeUpRight: true, // called on wipe top and right gesture
			wipeDownRight: true, // called on wipe bottom and right gesture
			wipeMove: true, // triggered whenever touchMove acts
