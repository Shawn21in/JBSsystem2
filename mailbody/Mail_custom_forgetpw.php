...
$url = $_setting_['WO_Url'].'/forgot_pw.php?c='.urlencode($_GET['c']);
...
<body>
	<article class="body <?=$colorSet?>">
		<article class="mailtop">
			...
			<table>
				<tr>
					<td align="left"><img src="<?=$URLweb.$_setting_['WO_FooterLOGO']?>" width="100"></td>
				</tr>
				<tr>
					<td><h2>忘記密碼重設信<span></span></h2></td>
				</tr>	
			</table>
		</article>
		...
		<article class="mailbody">
			...
			<p>您在「<?=$_setting_['WO_Title']?>」申請重設密碼，請點選以下按鈕進行密碼重設。<br>
			※如您的瀏覽器無法點擊[重設按鈕]，請複製[重設密碼連結]貼至您的瀏覽器網頁位置，再按下搜尋即可。<br></p>

			<table class="contact">
				<tr>
					<th width="30%" align="left"><p>重設按鈕 </p></th>
					<td width="70%" align="left"><p><a href="<?=$url?>">點我前去重設密碼</a></p></td>
				</tr>
				
				<tr valign="top">
					<th width="30%" align="left"><p>重設密碼連結 </p></th>
					<td width="70%" align="left"><a href="<?=$url?>"><?=$url?></a></td>
				</tr>
			...
			<table>
				<tr>
					<td>
						...
						<p class="name"><a href="<?=$_setting_['WO_Url']?>"><img src="<?=$URLweb.$_setting_['WO_FooterLOGO']?>" alt="" width="150"></a> </p>
