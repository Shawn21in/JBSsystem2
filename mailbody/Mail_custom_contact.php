...
$Input = GDC($_GET['c'] , 'custom_contact');
$v = $Input['v'];
...
<body>
	...
	<article class="body <?=$colorSet?>">
		...
		<article class="mailbody">
			...
			<p>您好：<br>感謝您花時間來信洽詢。<br>針對您提出的意見或問題，我們將確認後主動回覆，並會盡可能的提供您需要的協助。<br>同時，感謝您對我們的信賴和肯定，祝您有個愉快的一天！<br></p>
