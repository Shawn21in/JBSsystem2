...
$Input = GDC($_GET['c'] , 'admin_contact');
$v = $Input['v'];

$db = new MySQL();

$db->Where = " WHERE CT_Verify = '$v'";
$db->query_sql( "web_contact", '*');
$_html = $db->query_fetch();
...
<body>
	<article class="body <?=$colorSet?>">
		...
		<article class="mailbody">
			...
			有顧客於「<?=$_setting_['WO_Title']?>」留言，請盡速前往處理：</p>
			
			<table class="contact">
				<tr>
					<th width="30%" align="left"><p>留言時間 </p></th>
					<td width="70%" align="left"><p><?=$_html['CT_Sdate']?></p></td>
				</tr>
				<!--
				<tr valign="top">
					<th width="30%" align="left"><p>聯絡人 </p></th>
					<td width="70%" align="left"><p><?=$_html['Contact_Name']?> <?=$_html['Contact_Gender']==1?'先生':'小姐'?></p></td>
				</tr>
				-->
				<tr valign="top">
					<th width="30%" align="left"><p>聯絡電話 </p></th>
					<td width="70%" align="left"><p><?=$_html['CT_Tel']?></p></td>
				</tr>
				
				<tr valign="top">
					<th width="30%" align="left"><p>信箱 </p></th>
					<td width="70%" align="left"><p><?=$_html['CT_Email']?></p></td>
				</tr>
				<!--
				<tr valign="top">
					<th width="30%" align="left"><p>LINE 帳號 </p></th>
					<td width="70%" align="left"><p><?=$_html['Contact_Lineid']?></p></td>
				</tr>
				-->
				<tr valign="top">
					<th width="30%" align="left"><p>留言內容 </p></th>
					<td width="70%" align="left"><p><?=$_html['CT_Content']?></p></td>
				</tr>
				
				
			</table>
			<p class="tip">※ 祝 ! 使用愉快 ※
			<br>※ 本電子信箱為系統自動發送通知使用，請勿直接回覆 ※</p>	
			...
			<table>
				<tr>
					<td>
						...
						<p class="name"><a href="<?=ROOT_URL?>"><img src="<?=ROOT_URL.'/images/logo.png'?>" alt="" width="200"></a> </p>
						<p class="center">電話 / <?=$_setting_['WO_Tel']?></p>
			        	<p class="center">Email / <?=$_setting_['WO_Email']?></p>
			        	<p class="center"><a href="<?=ROOT_URL?>"><?=$_setting_['WO_Name']?></a></p>
					</td>
				</tr>
