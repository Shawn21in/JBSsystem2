...
$Input 	= GDC( $_GET['c'] , 'forgetpw_member_resend');
$code = $Input['v'];
...
<body>
	<article class="body <?=$colorSet?>">
		...
		<article class="mailbody">
			...
			<p>您在「<?=$_setting_['WO_Title']?>」申請補救密碼，請紀錄以下資料後回到登入頁面嘗試登入。<br>
			※請注意，申請補救密碼後，若登入的密碼是用補救密碼，會將原本的密碼替換成補救密碼，舊密碼會失效。反之，若登入的密碼是舊密碼，補救密碼則會失效。<br></p>

			<table class="contact">
				<tr>
					<th width="30%" align="left"><p>補救密碼 </p></th>
					<td width="70%" align="left"><p><?=$code?></p></td>
				</tr>
