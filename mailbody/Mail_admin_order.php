...
$db->Where = "Where Delivery_ID='".$_OrderData['Orderm_Delivery']."'";
$db->query_sql( "web_delivery" , '*');
...
<body>
	<article class="body <?=$colorSet?>">
		...
		<article class="mailbody">
			...
			<p>您的「<?=$_setting_['WO_Title']?>」網站成立了一筆訂單，請盡快前往處理：</p>
			
			<table cellpadding="0"  border-spacing="0" border-collapse="0" class="contact">
				<tr>
					<td width="30%" align="left"><p>商店訂單編號</p></td>
					<td width="70%" align="left"><p><?=$_OrderData['Orderm_ID']?></p></td>
				</tr>
				<tr>
					<td width="30%" align="left"><p>付款方式</p></td>
					<td width="70%" align="left"><p><?=$delivery?></p></td>
				</tr>
				<tr>
