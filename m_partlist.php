            ...
            <div class="col-12">
              <div class="col-lg-12">
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    <!-- <p class="mb-5"></p> -->
                    <button type="button" class="mb-1 btn btn-outline-primary" onclick="location.href='m_part.php'">
                          ...
                          <tr>
                            ...
                            <td>
                              <form onsubmit="return false;">
                                <a href="m_part.php?c=<?php echo OEncrypt('v=' . $value['partno'], 'part'); ?>"><span class="mdi mdi-pencil mdi-18px"></span></a>
                                <input type="hidden" name="partno" value="<?= rawurldecode(OEncrypt('v=' . $value['partno'], 'part')) ?>">
                                <a href="javascript:void(0)" class="delBtn" data-type="part_del"><span class="mdi mdi-delete mdi-18px"></span></a>
                              </form>
                            </td>
                          </tr>
                        <?php } ?>
